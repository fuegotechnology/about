...
3. Google Sheets/Microsoft Excel Alternate (Fuego Data)
4. Browser in client-side HTML (maybe)
5. Fuego Cloud (Azure, GCP, AWS free alternate)
6. Winedows a Windows Docker Image for Linux.
7. FuegoOS (Windows Alternate in HTML)
8. Graphics accelerator in JavaScript (JsGPU)
